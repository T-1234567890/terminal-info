...
```text
tinfo-docker-x86_64-apple-darwin.minisig
```
...
4. Add release checksums and a Minisign public key to `plugins/docker.json`
5. Submit or update `plugins/docker.json` in the Terminal Info repository
